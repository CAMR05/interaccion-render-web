...
window.addEventListener("mousemove", function(eventData){
    //Calcular la distancia entre el mouse y la última imagen dibujada para evaluar nuestra condición para renderizar o no.
    // 1.- Calcular distancia
    var dx = Math.abs(eventData.clientX - lastPos.x);
